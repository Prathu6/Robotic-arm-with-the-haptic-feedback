//IMU AND STEPPER MOTOR TESTING FOR YAWFOR 180 DEGREE ON ESP8266 TESING DONE (connect imu SDA-D2,SCL-D1)
...
#define STEP_PIN D6 // change pin number 
#define DIR_PIN  D5 //change pin number 
